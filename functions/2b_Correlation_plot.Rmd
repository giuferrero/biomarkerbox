...
scatterplot <- function(dat, id1, id2, coeff, covid, inlinep=FALSE){
  
  p <- ggplot(data=dat, aes(x=id1, y=id2, fill=Var2)) + 
    geom_point() +
  ...
  printout(paste0(outf,paste0("Correlation_Plot_Scatterplot_correlation_", id1, "_", id2,".pdf"), p))}
```
...
cat("The following plot represent all the correlation coefficients computed using the Pearson's method.\n\n This plot was provided as pdf file named **Correlation_Plot_Corrplot_Spearman_correlation.pdf**.\n\n", sep="")
```
...
cat("The following plot represent all the correlation coefficients computed using the Spearman's method.\n\n This plot was provided as pdf file named **Correlation_Plot_Corrplot_Spearman_correlation.pdf**.\n\n", sep="")
}
